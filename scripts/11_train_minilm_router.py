#!/usr/bin/env python3
"""Stage 7 — train ElJefe v0: fine-tuned dual-head MiniLM router.
...
(default artifacts/models/eljefe-v0).
"""
...
def main() -> None:
    ...
    from eljefe.router import load_router_dataset, train_minilm_router, update_manifest
    ...
    print(f"[11] saved ElJefe v0 -> {out_dir}")
